...
func (s *IDXGISwapChain) Release() int32 {
	ret, _, _ := syscall.Syscall(
		s.Vtbl.Release,
		1,
		uintptr(unsafe.Pointer(s)),
...
func (c *DeviceContext) OMSetBlendState(state *BlendState, factor *RGBA, sampleMask uint32) {
	syscall.Syscall6(
...
func (d *DeviceContext) Release() int32 {
	ret, _, _ := syscall.Syscall(
		d.Vtbl.Release,
		1,
		uintptr(unsafe.Pointer(d)),
